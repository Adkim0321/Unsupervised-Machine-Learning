...
From reviewing the model, the Elbow curve is showing 4 clusters and when we look at TSNE it seems to show that 4 clusters show a decent delination with out overfit.  Granted the starting point changes so each run so the data points will shift, but 4 seems to be the recommendation
